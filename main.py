...
class TypingSpeedTest:
    ...
    def setup_ui(self):
        ...
        self.paragraph_label = tk.Label(self.root, text=self.selected_paragraph, wraplength=700, font=("Arial", 14), justify="left")
        self.paragraph_label.pack(pady=20)
        
        # Typing Area
        self.text_area = tk.Text(self.root, height=5, width=70, font=("Arial", 14), state="disabled")
    ...
    def end_test(self):
        ...
        wpm = self.correct_words  # Words Per Minute (based on correct words)
        accuracy = (self.correct_words / self.total_words) * 100 if self.total_words else 0  # Updated formula
